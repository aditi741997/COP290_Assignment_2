...
\textbf{S.No.} & \textbf{Fields}     & \textbf{Type} & \textbf{Description}                            \\ \hline
1              & Complaint Id        & String        & Unique Id for Complaint                         \\ \hline
2              & User Id             & String        & Unique User Id or Anonymous                     \\ \hline
3              & Complaint Type      & Int           & Complaint category                              \\ \hline
4              & Complaint Content   & String        & Content of complaint                            \\ \hline
5              & Extra Info          & Image         & Upload a photo                                  \\ \hline
6              & Admin Id            & String        & Id of person assigned                           \\ \hline
...
\begin{table}[]
\centering
\caption{Complaint Response}
\label{my-label}
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{S.No.} & \textbf{Fields}        & \textbf{Type} & \textbf{Description}                        \\ \hline
1              & Complaint Id           & String        & Unique Id for Complaint                     \\ \hline
2              & Number of Up-votes      & Int           & Number of Up-votes                           \\ \hline
3              & Number of Down-votes    & Int           & Number of Down-votes                         \\ \hline
4              & Number of Neutrals     & Int           & Number of Neutral people                    \\ \hline
5              & Number of Satisfied    & Int           & Number of people satisfied                  \\ \hline
6              & Number of Dissatisfied & Int           & Number of people dissatisfied with solution \\ \hline
\end{tabular}
\end{table}
	...
	\section{Future Endeavors} 
		\begin{itemize} 
			...
			\item Feature to maintain persistent login will be added
		\end{itemize}   
	\section{Source Code}
